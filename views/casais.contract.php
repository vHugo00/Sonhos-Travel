...
$contrante = array(
    'esposa' => $casal['esposa_nome'],
    'esposa_cpf' => $casal['esposa_cpf'],
    'esposo' => $casal['esposo_nome'],
    'esposo_cpf' => $casal['esposo_cpf'],
    'endereco' => $casal['casal_endereco'] . ', ' . $casal['casal_cidade'] . ' - ' . $casal['casal_estado'] . ', CEP ' . $casal['casal_cep']
);

$pagamento = $casal['pagamento'];
$date = date('d \d\e M \d\e Y', strtotime($casal['created_at']));
...
<head>
    ...
    <style>
        ...
        .page {
            ...
            background-image: url('/assets/img/contratos/casais/bg.png');
...
<body>
    <div class="page">
        <div class="header">
            <img class="header-img" src="/assets/img/contratos/casais/header-img.png">
        </div>
        <div class="body">
            ...
            <p class="mt0">Contratantes: <?php echo $contrante['esposo']; ?> (CPF <?php echo $contrante['esposo_cpf']; ?>) e <?php echo $contrante['esposa']; ?> (CPF <?php echo $contrante['esposa_cpf']; ?>), residentes no(a) <?php echo $contrante['endereco']; ?>.</p>
        ...
        <div class="footer">
            <div class="content">
                <div class="contact-info">
                    <div style="font-weight: thin; font-size: .9em;text-align:left;">
                        <!-- <i class="fas fa-map-marker"></i>Rua Comendador Miro, 99 - Centro Ponta Grossa <br> -->
                        <i class="fab fa-instagram"></i>&nbsp;@sonhostravelviagem
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <i class="fab fa-facebook-square"></i>&nbsp;Sonhos Travel Agência de Viagens e Turismo</a>
                    </div>
                    <div style="font-weight: thin; font-size: .8em;text-align:left;">
                        <i class="fas fa-phone-square-alt"></i> 42 98874-0962 / 0800 299 0101
                        <!-- <i class="fas fa-phone-square-alt"></i> 0800 299 0101 -->
                    </div>
                </div>
            </div>
            <div class="base">
                <p>www.sonhostravelviagem.com.br</p>
            </div>
        </div>
    </div>
    <div class="page">
